            ...
            if (e != null) {
                ...
                while ((line = e.readLine()) != null) {
                    ...
                    if (linhaEstudante[3].equals("GRAD")) {
                        int horasAtividade = Integer.parseInt(linhaEstudante[4]);
                        estudantes.add(new EstudanteGrad(id, nome, email,horasAtividade));
                    }else{
                        estudantes.add(new EstudantePos(id, nome, email, linhaEstudante[4], linhaEstudante[5]));
                    }
                }
            }
